...
map.getView().fit([16056693.282763, -4610759.198182, 16058531.640167, -4610063.263566], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MDE</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (17 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'test MDE abstract';
            }
